...
<div class="container-fluid">
	...
	<?php include "menu.php"; ?>
		...
		<div class="col-md-7">
			<h3>Listado de Terapeutas</h3>
			<table class="table table-bordered table-striped display" id="terapeutaTable">
				<thead>
					<tr>
						<th>Rut</th>
						<th>Nombre</th>
